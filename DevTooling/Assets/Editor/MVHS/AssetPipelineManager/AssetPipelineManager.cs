    ...
    public class AssetPipelineManager : EditorWindow
    {
        ...
        private void LoadCombinedManifest()
        {
            ...
            foreach (string file in manifestFiles)
            {
                ...
                {
                    Debug.LogWarning($"[AssetPackageManager] Could not read manifest {file}: {e.Message}");
                }
            }
        }
        ...
        private void RefreshFolderStatuses()
        {
            ...
            foreach (string folder in AssetPipelineConfig.projectFolders)
            {
                ...
                if (existsOnDisk)
                {
                    string[] files = Directory.GetFiles(diskPath, "*.*", SearchOption.TopDirectoryOnly);
        ...
        private void DrawExportSection()
        {
            ...
            //    "Package: " + m_Config.GetPackageFileName(),
        ...
        private void ExportPackage()
        {
            ...
            Debug.Log($"[AssetPackageManager] Exported {assetPaths.Count} assets ({sizeLabel}). Manifest generated.");
        ...
        private void GenerateManifest(List<ManifestFolder> folders)
        {
            ...
            Debug.Log($"[AssetPackageManager] Manifest saved: {fileName}");
        }
        ...
        private void ImportPackage()
        {
            ...
            Debug.Log($"[AssetPackageManager] Import started from {openPath}");
        }
